...
export default async function LeiePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-[var(--foreground)] mb-2">Boliger til leie</h1>
        <p className="text-[var(--muted)]">{boliger.length} utleieboliger tilgjengelig</p>
      </div>

      {boliger.length === 0 ? (
        <div className="text-center py-24 bg-[var(--surface)] rounded-xl border border-[var(--border)]">
          <div className="text-5xl mb-4">🔑</div>
          <h2 className="text-xl font-semibold text-[var(--foreground)] mb-2">Ingen boliger ute for leie</h2>
