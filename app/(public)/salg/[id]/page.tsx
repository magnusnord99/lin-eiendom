...
export default async function SalgDetalj({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!bolig || bolig.type !== "salg") notFound();
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                <span className="inline-block bg-[var(--primary)] text-white text-xs font-semibold px-3 py-1 rounded-full mb-3">
                  Til salgs
                </span>
            ...
            <div className="prose prose-sm max-w-none text-[var(--muted)] leading-relaxed">
              ...
              <p className="whitespace-pre-wrap">{bolig.beskrivelse}</p>
            </div>
          </div>
